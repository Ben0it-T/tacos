...
$( document ).ready(function() {
    $("#customer_edit_form_color").change(function(){
        let color = ($("#customer_edit_form_color").val() === "") ? "#ffffff" : $("#customer_edit_form_color").val();
        $("#team_color").css("background-color", color);
    });
